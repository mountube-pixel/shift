...
// NOTA: Aggiunto $h come primo parametro obbligatorio
export const renderAdminPage = ($h, pageName, contentFunc, f7_instance) => {
  ...
  const openLangMenu = () => {
    const actions = f7_instance.actions.create({
      buttons: [
        [
          { text: 'Seleziona Lingua', label: true },
  ...
  // Funzione Helper per rimuovere il focus e prevenire l'errore ARIA
  ...
  // Render Function
  return () => {
    // Passiamo $h alla funzione di contenuto
    ...
    <div class="page admin-page" data-name="${pageName}">
      ...
      <div class="admin-grid-container">
         ...
         <aside class="admin-sidebar" id="admin-sidebar-el">
            ...
            <nav class="sidebar-nav">
               <a href="/admin/" class="nav-item ${pageName === 'admin-home' ? 'active' : ''}" @click=${handleNavClick}>
                  <i class="icon f7-icons">chart_bar_fill</i> ${t('admin.dashboard')}
               </a>
               <a href="/admin/users/" class="nav-item ${pageName === 'admin-users' ? 'active' : ''}" @click=${handleNavClick}>
                  <i class="icon f7-icons">person_2_fill</i> ${t('admin.users')}
               </a>
               <a href="/admin/orgs/" class="nav-item ${pageName === 'admin-orgs' ? 'active' : ''}" @click=${handleNavClick}>
      ...
      <style>
        ...
        .admin-page { background: #f4f6f8; height: 100vh; display: flex; flex-direction: column; overflow: hidden; }
        ...
        .admin-grid-container { display: flex; flex: 1; overflow: hidden; position: relative; }
